...
class MenuController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('AppBundle:Menu:new.html.twig', array(
            'menu' => $menu,
    ...
    public function showAction(Menu $menu)
    {
        ...
        return $this->render('AppBundle:Menu:show.html.twig', array(
            'menu' => $menu,
    ...
    public function editAction(Request $request, Menu $menu)
    {
        ...
        return $this->render('AppBundle:Menu:edit.html.twig', array(
            'menu' => $menu,
